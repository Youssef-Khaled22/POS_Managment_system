...
class EmployeesDAOImpTest {
    ...
    void findAll() {
        ...
        assertEquals("[Employees{id=12345678900005, name='ahmed', jop='Cashier', gender='Male', salary=10000, birthDate='1999-01-01', phone=099649778585, userName='ahmed', password='202cb962ac59075b964b07152d234b70'}, " +
                ...
                "Employees{id=00000123456789, name='yusuf', jop='Cashier', gender='Male', salary=30000, birthDate='2001-09-01', phone=097986, userName='yusuf', password='202cb962ac59075b964b07152d234b70'}]",obj.findAll().toString());
    }
    ...
    void update() {
        EmployeesDAOImp obj = new EmployeesDAOImp();
        Employees obj2 = new Employees("12345678900005","ahmed","Cashier","Male",10000,"jkbgkhghg", Date.valueOf("1999-01-01"),"099649778585","mahmoud", POS_System.doHashing("123"));
